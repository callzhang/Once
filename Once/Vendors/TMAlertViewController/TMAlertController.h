...
typedef NS_ENUM(NSUInteger, TMAlartControllerStyle) {
	...
	TMAlertControllerStyleTextField,
};

typedef NS_ENUM(NSUInteger, TMAlertControlerIconStyle) {
	TMAlertControllerIconStyleNone,
    TMAlertControllerIconStyleQustion,
    TMAlertControllerIconStyleThumbsUp,
    TMAlertControllerIconStylePhone,
	TMAlertControllerIconStyleNote,
};
@class TMAlertAction;
